# Делал давно. Работает, так что переписывать не спешу. А по факту - МЯСО!
...
class AoS:
    def __init__(self, x, y, range_of_visibility, map_of_transparency):
        self.walls = []
        self.aos = []
        self.checked = []
        self.transparent = map_of_transparency
        self.vrange = range_of_visibility
        self.x = x
        self.y = y
        self.shadows = []
        for x in range(80):
